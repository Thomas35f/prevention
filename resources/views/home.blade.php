                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 title-home">
                                <div class="hero__caption">
                                    <h1>{{ __('home.title_1') }}
                                        <span>{{ __('home.road') }}</span><br>{{ __('home.title_2') }}
                                    </h1>
                                </div>
                            </div>
                            @if (!Auth::check())
                                    ...
                                    <div class="form-login">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="input-login">
                                                ...
                                                <x-text-input id="password" class="block mt-1" type="password"
                                            ...
                                            <div class="block mt-4">
                                                <label for="remember_me" class="inline-flex items-center">
                                                    ...
                                                    <span
                                                        class="ml-2 text-sm text-white">{{ __('login.remember_me') }}</span>
                                                </label>
                                            </div>
